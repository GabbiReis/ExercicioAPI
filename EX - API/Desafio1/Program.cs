        ...
        static async Task Main(string[] args)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                try
                {
                    ...
                    DadosConsumidos data = Newtonsoft.Json.JsonConvert.DeserializeObject<DadosConsumidos>(responseBody);
                    ...
                    Console.WriteLine($"Nome - País: {data.country_name}");
                    Console.WriteLine($"Código - País: {data.country_code}");
                    Console.WriteLine($"Código - País: {data.country_code_iso3}");
                    Console.WriteLine($"Capital - País: {data.country_capital}");
